...
/**
 * Thread for reading from a database. 
...
public class ReadThread implements Runnable {
    ...
    public ReadThread(CountDownLatch countDownLatch, ConcurrentHashMap<String, Object> cb_config_map, ConcurrentHashMap<Integer, Long> map, int id) {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {                  
                ...
                rs.next();
                if (rs.getInt("COUNT(*)") >= (Integer) this.cb_config_map.get("readsPerSecond")) {
                    break;
                }
                Thread.sleep(500);
            }
